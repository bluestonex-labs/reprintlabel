		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reprint Label",
									"targetURL": "#ukcobrakesrfreprintlabelui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ukcobrakesrfreprintlabelui-display": {
								"semanticObject": "ukcobrakesrfreprintlabelui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uk.co.brakes.rf.reprintlabelui",
									"url": sap.ui.require.toUrl("uk/co/brakes/rf/reprintlabelui")
								}
							}
						}
					}
